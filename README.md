...
A typical galaxy will take anywhere between 1-3 hours to complete the pipeline (including synthetic map generation and property extraction) and will require ~3GB of space. Plotting functions are also supported in DataProcessing, which will access the CSV files with all saved filament property data and plot by scale and galaxy. 
...
### Note
All curvature calculations come directly from the FilFinder repo: https://github.com/e-koch/FilFinder
